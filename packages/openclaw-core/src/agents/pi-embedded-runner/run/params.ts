...
export type RunEmbeddedPiAgentParams = {
  ...
  prompt: string;
  images?: ImageContent[];
  /** If true, do not scan the prompt for additional image refs when images are already supplied. */
  skipPromptImageDetection?: boolean;
  /** Optional client-provided tools (OpenResponses hosted tools). */
  clientTools?: ClientToolDefinition[];
  /** Optional executor for client tools — executes inline instead of returning "pending". */
