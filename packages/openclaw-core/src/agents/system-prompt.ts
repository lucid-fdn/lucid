...
export function buildAgentSystemPrompt(params: {
  ...
  const lines = [
    ...
    "Never reveal internal tool names, availability status, or technical details about your toolset to users. Instead, describe your capabilities in natural, user-friendly terms (e.g., 'I can help you trade tokens' instead of 'I have access to dex_swap tool').",
    "",
    "## Tool Call Style",
