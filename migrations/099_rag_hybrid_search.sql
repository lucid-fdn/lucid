...
COMMENT ON FUNCTION match_rag_chunks IS 'Hybrid RAG search: vector similarity + full-text keyword matching via Reciprocal Rank Fusion (RRF). Falls back to pure vector search when no keyword query provided.';
