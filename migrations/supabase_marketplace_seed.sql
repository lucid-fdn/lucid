-- ============================================
-- SUPABASE MARKETPLACE SEED DATA
-- ============================================
-- Run this AFTER supabase_marketplace_schema.sql
-- to populate with sample organizations and assets
...
-- ============================================
-- 2. INSERT SAMPLE ASSETS (matching mock data)
-- ============================================
...
-- ============================================
-- 3. INSERT SAMPLE RATINGS
-- ============================================

-- Note: This requires authenticated users to exist
-- You'll need to create users first, then replace user_id with actual UUIDs
-- For now, we'll skip ratings in seed data

-- Example (replace 'YOUR_USER_UUID' with actual user ID):
-- INSERT INTO public.ratings (asset_id, user_id, score, comment) VALUES
--   ((SELECT id FROM public.assets WHERE external_id = 'mdl_mistral_7b'), 'YOUR_USER_UUID', 5, 'Excellent model!');

-- ============================================
-- 4. REFRESH MATERIALIZED VIEWS
-- ============================================

REFRESH MATERIALIZED VIEW public.asset_rating_agg;
REFRESH MATERIALIZED VIEW public.asset_run_agg;
REFRESH MATERIALIZED VIEW public.organization_stats;
...
-- View assets with organizations
SELECT 
  a.name,
  a.kind,
  a.version,
