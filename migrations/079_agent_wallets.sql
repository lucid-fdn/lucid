...
ALTER TABLE trading_policies
  ADD COLUMN IF NOT EXISTS transfer_mode TEXT NOT NULL DEFAULT 'defi_only'
...
COMMENT ON COLUMN trading_policies.transfer_mode IS 'Token transfer restriction: defi_only (swaps only), owner_only (withdraw to owner), unrestricted';
