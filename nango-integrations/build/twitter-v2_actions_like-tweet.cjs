...
// twitter-v2/actions/like-tweet.ts
var like_tweet_exports = {};
__export(like_tweet_exports, {
  default: () => like_tweet_default
});
module.exports = __toCommonJS(like_tweet_exports);
