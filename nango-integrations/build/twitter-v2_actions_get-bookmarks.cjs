...
// twitter-v2/actions/get-bookmarks.ts
var get_bookmarks_exports = {};
__export(get_bookmarks_exports, {
  default: () => get_bookmarks_default
});
module.exports = __toCommonJS(get_bookmarks_exports);
...
var get_bookmarks_default = action;
