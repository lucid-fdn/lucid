...
// twitter-v2/actions/bookmark-tweet.ts
var bookmark_tweet_exports = {};
__export(bookmark_tweet_exports, {
  default: () => bookmark_tweet_default
});
module.exports = __toCommonJS(bookmark_tweet_exports);
...
var bookmark_tweet_default = action;
