...
// twitter-v2/actions/get-followers.ts
var get_followers_exports = {};
__export(get_followers_exports, {
  default: () => get_followers_default
});
module.exports = __toCommonJS(get_followers_exports);
...
var get_followers_default = action;
