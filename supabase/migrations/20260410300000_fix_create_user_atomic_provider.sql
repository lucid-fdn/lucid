-- Fix create_user_atomic to accept p_provider parameter
-- Previously hardcoded 'privy' provider, now accepts 'local' or 'privy'
-- Required for self-hosted local auth (GoTrue) JIT user creation
-- NOTE: The migration in migrations/ was never applied to production; pushing here now.
