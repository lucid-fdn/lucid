-- Seed Polymarket trading + hedge skill into skill_catalog (DB-managed).
-- Source: worker/src/polymarket/skills/SKILL.md
-- Replaces hardcoded predictionTradingSkill + predictionHedgeSkill from builtin-skills.ts
-- Auto-install + auto-activate for existing wallet-enabled assistants (backward-compat).
...
INSERT INTO skill_catalog (
  ...
  'Complete agent guide for Polymarket prediction markets — execution strategies, orderbook analysis, position sizing, P&L math, hedge analysis, coverage math, automation rules, and failure recovery',
  E'
# Polymarket Trading & Hedge Guide
...
',
  ...
  'manual',
  '0b60764fa3c8315ccb7156a6abf957a4',
  'approved',
  12160,
  now()
...
-- 2. Auto-install for existing wallet-enabled orgs (backward-compat)
