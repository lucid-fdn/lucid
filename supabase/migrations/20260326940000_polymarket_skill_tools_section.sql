-- Update Polymarket skill content with Required Tools section for OpenClaw standalone compatibility.
-- Adds tool descriptions, contract addresses, and API endpoints so the skill is self-contained.
...
- When the user asks "what do I have?", use get_positions before answering
',
  content_hash = '973af01aa6ef56785858d0c75f2d3318',
  content_chars = 13634
