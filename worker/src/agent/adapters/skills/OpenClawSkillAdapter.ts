...
import { buildMountedSkillSelection, buildSkillsSnapshotFromRows } from '../../skills/snapshot-builder.js'
import type {
  CatalogSkillRecord,
  EngineMountedSkills,
  EngineSkillAdapter,
...
export class OpenClawSkillAdapter implements EngineSkillAdapter {
