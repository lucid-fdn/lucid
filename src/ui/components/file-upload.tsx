...
export type FileUploadProps = {
  ...
  /** Aceternity-compatible callback name. Prefer onFilesAdded internally. */
...
function FileUpload({
  ...
  const handleFiles = useCallback(
    (files: FileList) => {
      ...
      const acceptedFiles = multiple ? newFiles : newFiles.slice(0, 1)
      onFilesAdded?.(acceptedFiles)
      onChange?.(acceptedFiles)
    },
    [multiple, onChange, onFilesAdded]
  )
