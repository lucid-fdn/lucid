...
/**
 * PulsatingButton - Button with pulsing animation effect
 * Now wraps shadcn/ui Button for consistency
 * 
 * @example
 * <PulsatingButton pulseColor="rgba(139, 92, 246, 0.5)">
 *   Join Discord
 * </PulsatingButton>
 */
  ...
  (
    ...
    return (
      <Button
        ref={ref}
        className={cn(
          "relative gap-2 bg-black text-white hover:bg-black/90",
          className
        )}
        style={
          {
