...
export const HeroImage = () => {
  ...
  return (
    <Container className="border-divide relative flex items-start justify-start border-x bg-gray-100/60 backdrop-blur-lg p-2 perspective-distant md:p-4 lg:p-8 dark:bg-neutral-800/60">
      <Dot top left />
      <Dot top right />
      <Dot bottom left />
      <Dot bottom right />
