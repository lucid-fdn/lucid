...
import {
  ...
  ScreenCogIcon,
  BellIcon,
} from "@/components/marketing/lucid/icons/card-icons";
import { Scale } from "./scale";
import { AnimatePresence, motion } from "motion/react";
import { RealtimeSyncIcon } from "@/components/marketing/lucid/icons/bento-icons";
import { DivideX } from "./divide";
import { LogoSVG } from "./logo";
import { OpenAILogo, SlackLogo } from "@/components/marketing/lucid/icons/general";
...
export const Benefits = () => {
  ...
  return (
    <Container className="border-divide relative overflow-hidden border-x px-4 py-20 md:px-8">
      <SectionHeader
        badge="Benefits"
        title="Making Engineers 10x faster"
