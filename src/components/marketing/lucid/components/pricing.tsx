...
import { tiers } from "@/components/marketing/lucid/constants/pricing";
  ...
  return (
    <section className="">
      <Container className="border-divide flex flex-col items-center justify-center border-x pt-10 pb-10">
        <SectionHeader
          badge="Pricing"
          title="Simple pricing for autonomous agents"
          description="Start small on shared compute, then scale into stronger continuity and isolation as your agents take on more work."
        />
