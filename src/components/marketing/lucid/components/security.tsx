  ...
  return (
    <>
      ...
      <Container className="border-divide grid grid-cols-1 border-x bg-gray-100 px-8 py-12 md:grid-cols-2 dark:bg-neutral-900">
        <div>
          <SectionHeader
            title="Scale securely with confidence"
            description="Our AI agents are designed with enterprise-grade security practices and compliant with global data protection standards."
            align="left"
