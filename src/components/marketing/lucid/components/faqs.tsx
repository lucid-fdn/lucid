...
import { faqs } from "@/components/marketing/lucid/constants/faqs";
...
export const FAQs = () => {
  ...
  return (
    <Container className="border-divide flex flex-col items-center border-x pt-12">
      <SectionHeader
        badge="FAQs"
        title="Questions people ask before they trust agents"
        description="The fastest way to understand what Lucid does, why it is different, and how it stays under control."
        descriptionClassName="max-w-lg px-2"
      />
      <div className="mt-8 mb-12 flex w-full flex-col justify-center gap-4 px-4 sm:flex-row">
        <Button as="a" href="https://docs.lucid.foundation" variant="primary" className="w-full sm:w-auto">
          Read Docs
        </Button>
        <Button
          as="a"
