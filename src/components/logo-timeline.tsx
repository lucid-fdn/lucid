    ...
    >
      {isAnimated ? (
        <Image
          ...
          unoptimized
          onMouseEnter={(e) => {
            (e.currentTarget as HTMLImageElement).src = '/lucid_w.gif';
          }}
          onMouseLeave={(e) => {
            (e.currentTarget as HTMLImageElement).src = '/lucid_w.png';
          }}
        />
      ) : (
        <Image alt="" src={src} width={16} height={16} className="size-4" unoptimized />
      )}
  ...
  return (
    <div aria-hidden="true" className="relative h-full overflow-hidden">
      <div className="absolute inset-0 top-8 z-10 flex items-center justify-center">
        ...
        />
        <div className="relative flex size-24 items-center justify-center rounded-xl bg-linear-to-t from-white/5 to-white/25 shadow-sm ring-1 ring-white/10 outline outline-offset-[-5px] outline-white/5 ring-inset backdrop-blur-md">
          <Image
            alt="Lucid"
            src="/lucid_w.gif"
            width={36}
      ...
      <div className="@container absolute inset-0 grid grid-cols-1 pt-8">
        ...
        <Row>
          <Logo
            ...
            src="/logos/adobe-creative-cloud.svg"
