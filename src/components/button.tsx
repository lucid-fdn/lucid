/**
 * @deprecated This button component is deprecated. Use '@/components/ui/button' (shadcn/ui) instead.
 * 
 * Migration guide:
 * - Import from: '@/components/ui/button'
 * - Props changes:
 *   - color → variant or custom className
 *   - outline → variant="outline"
 *   - plain → variant="ghost"
 *   - size → size (supports: default, sm, lg, icon, icon-sm, icon-lg)
 *   - For links: Use asChild prop with <a> tag inside
 * 
 * Example:
 * Old: <Button color="blue" href="/path">Click</Button>
 * New: <Button asChild className="bg-blue-600"><a href="/path">Click</a></Button>
 */
