...
import { approveAgentCommerceSpendRequest } from '@/lib/agent-commerce/service'
...
export const POST = withCSRF(async (
  ...
  try {
    ...
    await enforceAgentCommerceRateLimit({
      ...
      bucket: 'agent-commerce:public:spend-approve',
      ...AGENT_COMMERCE_RATE_LIMITS.publicSpendMutation,
    })
    const spendRequest = await approveAgentCommerceSpendRequest({
      id,
      orgId: body.orgId,
      userId,
      requestId,
