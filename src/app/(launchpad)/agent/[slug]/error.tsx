...
export default function AgentDetailError({
  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-4 text-center">
      ...
      <h2 className="text-xl font-semibold text-white">Agent Not Available</h2>
      <p className="mt-2 max-w-md text-sm text-slate-400">
        {error.message || 'This agent could not be loaded. It may have been removed or is temporarily unavailable.'}
      </p>
